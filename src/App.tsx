            ...
            <Suspense fallback={
              ...
              <PageTransition>
                <Routes>
                  ...
                  {SHOW_ABOUT && <Route path="/about" element={
                    <RouteErrorBoundary>
                      <About />
                    </RouteErrorBoundary>
                  } />}
                  {SHOW_ROBOTS && <Route path="/robots" element={
                    <RouteErrorBoundary>
                      <Robots />
                    </RouteErrorBoundary>
                  } />}
                  {SHOW_TEAM && <Route path="/team" element={
                    <RouteErrorBoundary>
                      <Team />
                    </RouteErrorBoundary>
                  } />}
                  {SHOW_GALLERY && <Route path="/gallery" element={
                    <RouteErrorBoundary>
                      <Gallery />
                    </RouteErrorBoundary>
                  } />}
                  {SHOW_SPONSORS && <Route path="/sponsors" element={
                    <RouteErrorBoundary>
                      <Sponsors />
                    </RouteErrorBoundary>
                  } />}
                  {SHOW_CONTACT && <Route path="/contact" element={
                    <RouteErrorBoundary>
                      <Contact />
                    </RouteErrorBoundary>
                  } />}
                  {SHOW_FAQ && <Route path="/faq" element={
                    <RouteErrorBoundary>
                      <FAQPage />
                    </RouteErrorBoundary>
                  } />}
            ...
            <div className="footer-content">
              ...
              <div className="footer-social">
                ...
                {contactInfo.social.youtube && (
                  <a href={contactInfo.social.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                {contactInfo.social.twitter && (
                  <a href={contactInfo.social.twitter} target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                    <svg viewBox="0 0 24 24" fill="currentColor">
